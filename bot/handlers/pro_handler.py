...
"Слушай, тут всё на самом деле просто. Отели — это скоропортящийся продукт. Если номер сегодня ночью пустой, отель потерял деньги навсегда._

Поэтому они готовы отдавать эти номера закрытым клубам, типа нашего, со скидкой 50-70%, лишь бы заполнить._

Но они запрещают показывать эти цены публично на Букинге или Островке, чтобы не рушить рынок. А нам внутри клуба — можно. Вот и весь секрет. Ты просто получаешь доступ к оптовым ценам, которые скрыты от обычных туристов."_
...
Запиши 🎙 для тех, кто хочет 'Уволиться из найма'.

📝 **Сценарий:**

"Я прекрасно понимаю чувство, когда живешь от выходных до выходных.

Этот бизнес хорош тем, что его можно строить параллельно с работой, в телефоне. 

Это твой запасной аэродром, который скоро станет основным. 

Посмотри план, как выйти на $2000."
...
"Слушай, мы все хотим путешествовать чаще, но вечно откладываем это «на потом». 

Всегда находятся дела поважнее, куда потратить деньги._

А здесь система построена так, что ты по чуть-чуть откладываешь себе на счет — как подписка. 
...
Не потому что надо напрягаться и искать деньги, а потому что они уже там. 

Это реально самый простой способ начать ездить куда-то 3-4 раза в год."
